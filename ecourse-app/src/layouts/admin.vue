...
<template>  
    <header>
        <nav class="flex justify-between fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <img :src="require('@/assets/logo.png')" class="h-32" alt="HR*YJ Logo" />
            <div style="margin-right: 3%;" v-if="isLoggedIn" class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" 
                    ...
                    <img class="w-16 h-16 rounded-full" :src="require('@/assets/avatar-default.png')" alt="user photo">
                </button>
                <!-- Dropdown menu -->
    ...
    <main>
        <aside id="logo-sidebar" class="fixed top-16 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <router-link to="/lessons-list-admin">
                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <div class="p-4 sm:ml-64" style=" margin-top: 8rem;">
            <slot/>
        </div>
    </main>
    <footer>
